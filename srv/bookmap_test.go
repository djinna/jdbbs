...
func TestBuildBookMap(t *testing.T) {
	...
	cases := []struct {
		...
		{
			name: "nothing left after drops is a high-severity error",
			paras: []docxPara{
				p("title", "Empty Book"), p("heading1", "Contents"), p("normal", "[tk]"),
			},
			title:    "Empty Book",
			front:    []string{},
			body:     []string{},
			back:     []string{},
			untitled: []string{},
			warnHas:  []string{"This file has no body text"},
		},
		{
			name: "typed Contents with real text under it is a warning, not a note",
			paras: []docxPara{
				p("heading1", "Contents"), p("normal", "one two three four five six seven eight nine ten one two three four five six seven eight nine ten"),
				p("normal", "one two three four five six seven eight nine ten one two three four five six seven eight nine ten"),
				p("normal", "one two three four five six seven eight nine ten one two three four five six seven eight nine ten"),
				p("normal", "one two three four five six seven eight nine ten"),
				pb("heading1", "Chapter 1"), p("normal", "x"),
			},
			title:    "Book",
			front:    []string{},
			body:     []string{"Chapter 1"},
			back:     []string{},
			untitled: []string{},
			warnHas:  []string{"are dropped because the contents page is generated by the build — that is more than a typed contents list"},
		},
		{
