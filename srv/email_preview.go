...
func emailPreviewFixtures(base string) []emailPreview {
	...
	return []emailPreview{
		...
		{Kind: "build_delivered", Subject: "Build ready: " + book.Title, Text: buildDeliveredText(pass, book, pdfURL, epubURL, reportURL, credits, total), HTML: buildDeliveredHTML(pass, book, pdfURL, epubURL, reportURL, credits, total)},
