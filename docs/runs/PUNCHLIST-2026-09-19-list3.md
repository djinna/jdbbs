<!-- exported 2026-09-19 23:38 UTC by scripts/punchlist-export.py; source scratch/run/CHECKLIST.md + notes.json -->
...
- [x] 0.28 **Builds: split EPUB from PDF? unlimited EPUB, 3 PDF — or another way to think about it.** Discussion + options posted; decision needed. (Jenna 2026-09-19 ~23:00)
  ...
  > **shelley** · 2026-09-19 23:37 UTC  
  > Done and live. Final export smoke on mcheck: clean PDF (no PROOF line), 1 credit debited, receipt "Final files ready" with "Finals remaining". Copy updated everywhere: /factory (What's included, Price, step 4, add-ons "+3 finals"), /factory/api (`kind`, 402/429, `?kind=final`), CLI/demo script, Stripe product renamed "+3 finals" (synced automatically at startup), EMAIL_SYSTEM.md. Ticking.
