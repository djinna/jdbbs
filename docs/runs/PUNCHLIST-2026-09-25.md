<!-- exported 2026-09-25 13:37 UTC by scripts/punchlist-export.py; source scratch/run/CHECKLIST.md + notes.json -->
...
- [ ] 3.2 YOU — deck: cut / reorder / add beats · 3.4 BOTH run-through · 3.5 ME push + link
  ...
  > **jenna** · 2026-09-23 15:10 UTC  
  > slide 2 -- add in a brief reference to the seesaw between pages and scrolls, since that hasn't gone away, and modern books can exist online as well in non-print forms where you have to make a decision about whether to turn it back into a scroll. I also have examples now of a book from archive.org where they show book facsimiles. This could be its own page, of course. See what you think.
  >
  > ![screenshot](img/20260923-150858-062.png)
  >
  > ![screenshot](img/20260923-150942-308.png)

  > **shelley** · 2026-09-23 15:11 UTC  
  > Looked at slide 2 and the two screenshots (Glaister’s *Encyclopedia of the Book*, and archive.org’s thumbnail grid of it). What I think: the seesaw is already half-planted — the shoulder line says “You are reading this on a scroll” and the cover is a scroll wrapped round a codex. So slide 2 needs one added beat, not a rewrite. Proposal, two sizes:
  >
  > **(A) Slide 2 only, ~2 min to land.** Shoulder becomes: “You are reading this on a scroll. Sequential access only, no flipping ahead. The seesaw never stopped: every book that goes online has to decide whether to become a scroll again.” Plus one speaker note: *archive.org shows a codex as a grid of page thumbnails — a scroll of pages. The EPUB is a scroll; the PDF is a codex. The factory makes both, and the author decides.*
  >
  > **(B) Its own slide, after slide 3 (tablet → scroll → codex).** Title “The seesaw”, the archive.org grid as the image (your second screenshot, cropped to the top two rows so the cover + title pages read), shoulder: “A codex, digitised, comes back as a scroll of pages. Reflowable EPUB is a scroll; print PDF is a codex. Modern books are both, and someone has to choose.” Notes carry the Glaister example (a reference book — the most random-access kind of codex — shown sequentially). ~15 min, adds ~40 s to the 26.
  >
  > My vote: **A now, B only if you want a beat to breathe on** — slide 3 already lands “codex won by less effort”; B risks saying it twice. Say A or B (or both) and I push; the deck is served from disk so no rebuild. Note: the deck is at 15:10 UTC — if you are already on stage, I hold.

  > **jenna** · 2026-09-23 15:16 UTC  
  > A

  > **shelley** · 2026-09-23 15:16 UTC  
  > A is live: https://jdbbs.exe.xyz/2026-pi-symposium/og-protocols — slide 2 shoulder now ends “The seesaw never stopped: every book that goes online has to decide whether to become a scroll again.” and a speaker note carries the archive.org / Glaister example + “EPUB is a scroll, print PDF is a codex; the factory makes both, the author decides.” Hard-refresh the deck tab (served from disk, no restart). Committed in jdbbs-public 2772494.

  > **jenna** · 2026-09-23 15:18 UTC  
  > Hmm I think the image of all the pages from Archive.org needs to be there. don't think I gave you the link before? https://archive.org/details/encyclopediaofbo00geof/mode/thumb

  > **shelley** · 2026-09-23 15:20 UTC  
  > Image is in. New slide 3 (of 27 now), right after tablet → scroll → codex: full-bleed archive.org thumbnail grid (your screenshot, top two rows, cover at left), title “The seesaw never stopped.”, caption naming Glaister on archive.org, shoulder “Every book that goes online decides again: pages or scroll? Reflowable EPUB is a scroll; the print PDF is a codex. The factory makes both. The author chooses.”, link to the /mode/thumb URL, three speaker notes. Slide 2 keeps the one-line seesaw tease from A. Adds ~40 s; timestamps after it are unchanged, so treat data-t as +0:40 from here. Hard-refresh: https://jdbbs.exe.xyz/2026-pi-symposium/og-protocols (jdbbs-public 4f3e67b, 2c…).

  > **jenna** · 2026-09-23 15:22 UTC  
  > 1/screenshot full bleed like that is pretty fuzzy, try something else?
  > 2/the red text on slide 2 needs to revert to what it was instead of repeating this new beat? "Protocol
  > You are reading this on a scroll. Sequential access only, no flipping ahead. The seesaw never stopped: every book that goes online has to decide whether to become a scroll again."

  > **shelley** · 2026-09-23 15:25 UTC  
  > Both done, live at https://jdbbs.exe.xyz/2026-pi-symposium/og-protocols (slide 3 of 27). 1/ The fuzz was my doing: I had cropped your screenshot to a 1920×706 band and stretched it as a background. Now it is a contained figure at native resolution — the first 5 columns × 3 rows of the archive.org grid (cover → introduction), bordered, filling the right two-thirds like the other shot slides. 2/ Slide 2 red text reverted to “…Sequential access only, no flipping ahead. Hold that thought.” — the seesaw beat lives only on slide 3 now.

  > **jenna** · 2026-09-23 15:32 UTC  
  > 1/ swap current 3 and 4, let's introduce the scroll-page seesaw before we hit the "hold in the hand" beat I think. 2/ Add a note that the book on our new page was suggested by a participant in the workshop. 3/ See 3.6 and 3.7 in our punchlist -- I'm looking for other places where we can add the workshop in now -- I bet you can pull together a nice slide or two that anonymizes the attendee notes we pulled together earlier today?
  >
  > ![screenshot](img/20260923-153047-840.png)
  ...
  > **shelley** · 2026-09-23 15:36 UTC  
  > All three live at https://jdbbs.exe.xyz/2026-pi-symposium/og-protocols (now 29 slides).
  >
  > 1/ Order is now Opening → **The seesaw never stopped** (2) → First the book had to fit the hand (3) → trim size (4). I read “hold in the hand” as the tablet/scroll/codex slide; if you meant the seesaw *after* fit-the-hand but before trim, say so and I flip it back — one line.
  >
  > 2/ Seesaw caption now reads “…on archive.org — a workshop participant pointed us to it this week — …”, plus a speaker note to credit the room.
  >
  > 3/ Two new slides in The Book Factory, after Preflight and before the API slide (24 and 25 of 29), anonymised from §6:
  > • **24 “This week the room ran the factory. Eight manuscripts, no studio in the loop.”** — four big numbers: 8 authors/teams · 24 uploads / 28 builds (613 KB → 124 pp in 11 s) · 66 min from paid pass to finished book · 4 failures that were ours, each fixed live same day (fastest 27 min). Caption: 953 markers all resolved / 21 declared styles. Notes carry the details.
  > • **25 “What the room taught the factory.”** — four cards, what they did → what broke → what changed: the template followed exactly (title-as-H1, empty finals) · a name we already used (break / center, error pointed at the wrong party) · a style is only a name (21 styles, [[commentary]]) · poets invent structure (verse stacking, verse2/break2). Caption = the three 3.6 lines (footnotes, maths, styles are names). Nobody named; the CLI demo (6.2) is excluded from the counts.
  >
  > Cut or reorder freely — the cards are independent. 3.6 and 3.7 are covered by slide 25 if you want to tick them.

  > **jenna** · 2026-09-23 15:36 UTC  
  > let's swap order of these two slides:
  > Be regular and orderly in your life like a bourgeois, so that you may be violent and original in your work.
  > Same protocol, different voices.

  > **shelley** · 2026-09-23 15:36 UTC  
  > Swapped, live: the Flaubert quote (“Be regular and orderly…”) now comes first, then “Same protocol, different voices.” Times exchanged with them (3:20 / 2:50).

  > **jenna** · 2026-09-23 15:41 UTC  
  > fix: when I use the font switcher, the typesize gets sticky in a way that's incorrect

  > **jenna** · 2026-09-23 15:43 UTC  
  > fix: if we can, shift-space should go backward, like space goes forward

  > **shelley** · 2026-09-23 15:44 UTC  
  > Shift-space goes back now — on the deck, inside the image zoom, and in the notes window (its hint text says so). Live.
  >
  > On the font-switcher size stickiness: I switched JetBrains → Garamond → JetBrains → Martian → JetBrains here and every size (html, h2, caption, cards, shoulder) returned exactly to the face’s own numbers, and no slide overflows in any face. So I can’t reproduce it blind. Can you tell me: which face you switched *from* and *to*, whether it is the whole slide or one element (headline? the new cards? the running head?), and whether reloading the page fixes it? A screenshot into this box would settle it fast.

  > **jenna** · 2026-09-23 15:49 UTC  
  > This slide: "Now the factory fits on a laptop." let's drop in this screenshot from the earlier similar slide to help make this contrast clear and fun? maybe upper left corner, not too large since it's meant to be a callback?
  >
  > ![screenshot](img/20260923-154816-433.png)

  > **shelley** · 2026-09-23 15:51 UTC  
  > Done, live: your screenshot of “Publishing was always factory to factory” sits upper-left on “Now the factory fits on a laptop” — small (about a sixth of the width), thin border, soft shadow, a 1.5° tilt so it reads as a pinned callback rather than a layout element, mono caption “callback: five trades, four handoffs”. It stays clear of the headline in every face. Say if you want it bigger, straight, or captionless.

  > **jenna** · 2026-09-23 15:52 UTC  
  > nice, but maybe 20-30% larger?

  > **shelley** · 2026-09-23 15:53 UTC  
  > Bumped ~35 % (about a quarter of the slide width now); still clears the headline with room to spare. Live.

  > **jenna** · 2026-09-23 15:55 UTC  
  > hmmm still hard to make the connection I'm hoping we make. "Now the factory..." is focused on the the first two steps of the full process from the earlier slide. ideas?

  > **shelley** · 2026-09-23 15:57 UTC  
  > Tried a different idea, live: instead of the screenshot, the five-trades chain itself is redrawn in miniature directly above the two-factory diagram — same black stations and arrows, but Printer / Binder / Bookseller are dimmed to ghosts and only Author → manuscript → Compositor is lit. Under the lit pair, teal labels “= Venkat’s factory” / “= Jenna’s factory”, a teal bracket “the first handoff, five centuries on”, and a faint “the rest of the chain: two slides on” under the ghosts (which is true: slide 19 is “The last handoff is still to a printer”). Caption now says it in words too: it is the author-to-compositor handoff with a machine on each side; the printer is still a printer.
  >
  > So the eye reads: old chain → zoom into its first link → that link, today. If it is too much, the fallbacks are (a) keep the ghost row but drop the bracket, or (b) go back to the screenshot with a red box drawn around Author→Compositor. Say which.

  > **jenna** · 2026-09-23 15:57 UTC  
  > this might help too: has always been months to go from final ms to final page proofs and now happens in a minute *if/when* the mise en place is in place

  > **shelley** · 2026-09-23 15:58 UTC  
  > Added, live. Caption on “Now the factory fits on a laptop” now carries, in bold: “Final manuscript to final page proofs has always taken months. Now it takes a minute” — followed by “if, and only if, the mise en place is in place.” It doubles as the set-up for the Mise en place slide two on. Speaker note added with the same beat.

  > **jenna** · 2026-09-23 16:05 UTC  
  > add a new slide if we can make a screenshot similar to the history of the book image -- that is all the slides from this deck?? to follow current slide two "Books are OG protocols"?
  >
  > ![screenshot](img/20260923-160425-151.png)

  > **jenna** · 2026-09-23 16:08 UTC  
  > stop if too hard? or can I grab the screenshots for you? our session is running long now

  > **shelley** · 2026-09-23 16:09 UTC  
  > One more try with a different capture route (a screen recording of the deck scrolling, frames cut out) — ten minutes. If that fails I stop and we leave it; no need for you to grab anything.

  > **jenna** · 2026-09-23 16:11 UTC  
  > nb might as well skip the first slide with the youtube...or keep if it helps us fill the grid I suppose

  > **jenna** · 2026-09-23 16:12 UTC  
  > it's not numbered by the way, slide 0 I guess

  > **shelley** · 2026-09-23 16:18 UTC  
  > Got it — live as slide 3 of 30: “This talk, in the same view.” All thirty screens (your slide 0 with the YouTube still included, top-left, to fill the grid) as a 6×5 thumbnail grid on black, archive.org style, right after the seesaw slide so the two views sit back to back. Caption: “You will see them one at a time, in order — a scroll. Here they are all at once — pages. Same content; you choose the access.” Shoulder: “A deck is a scroll that wants to be a codex. So is an EPUB. So is this web page.”
  >
  > Two honest notes: (1) the grid was shot before this slide existed, so it shows 29 + slide 0 and does not contain itself — I can re-shoot in one pass tomorrow if you want the recursion exact; (2) if you meant it to go *before* the seesaw (straight after “Books are OG protocols”), say so and I move it — one line.
  >
  > Side effect worth having: the deck now takes #p12-style deep links (…/og-protocols#p12 opens screen 12).

  > **jenna** · 2026-09-23 16:20 UTC  
  > nice! let's make the grid 1 col narrower so that the aspect ration matches the other grid a little better and the slides are a little bigger. taller grid fine

  > **shelley** · 2026-09-23 16:21 UTC  
  > Done, live: grid is now 5 across × 6 down — taller, tiles about a fifth bigger, aspect much closer to the archive.org slide before it.

  > **jenna** · 2026-09-23 16:22 UTC  
  > hmm let's push to 4 across now too, keep 5 across in case we want to revert. also slide 0 - would be nice to show the early frame in the youtube video that actually says "Birth of a Book"

  > **shelley** · 2026-09-23 16:25 UTC  
  > Live: grid is 4 across × 8 down (30 tiles, so the last two cells bottom-right are black — shout if that bothers you and I fill them with the seesaw + this slide as a wink). 5-across kept at 2026-pi-symposium/src/grid5.webp for revert.
  >
  > Slide 0: pulled the Telegraph video and grabbed the “Birth of a Book” title card (≈4.6 s in). It is now both the still behind the pre-roll (what shows before/if YouTube loads) and the slide-0 tile in the grid.

  > **jenna** · 2026-09-23 16:28 UTC  
  > 1 more new slide: Tim Bei/ko mentioned Tim O'Reilly in the opening panel and so let's show O'Reilly book cover series compared to Metalabel's early books, some publisher's model lends itself to factory end of the craft–factory spectrum, Metalabel on the other end. dropping a couple of screenshots for you to use: google image search for O'Reilly and then two books from Metalabel. YOu can decide where to drop it in
  >
  > ![screenshot](img/20260923-162702-038.png)
  >
  > ![screenshot](img/20260923-162710-205.png)
  >
  > ![screenshot](img/20260923-162740-145.png)

  > **shelley** · 2026-09-23 16:32 UTC  
  > Live as slide 24 of 31: “Publishers already sit somewhere between factory and craft.” Three images in a row — the O’Reilly image-search grid (wide, left), then Antimemetics and The Politics of Privacy (the Metalabel product photos, cropped to just the books). Captions: O’Reilly since 1988, one template / one engraved animal / one colour band, the series *is* the design — the factory end; Metalabel 2025, every release designed from zero — the craft end, the object is the point. Body copy names Tim O’Reilly from this morning’s panel and lands “a template is a brand, not a compromise”; shoulder: “A series design is a protocol the reader learns once. Constraint at the factory end is what lets a small press look like a press.”
  >
  > I put it right after “Three styles to start. The constraint is the feature.” (and before Preflight) — it is the historical proof of that slide’s claim, and it keeps the Tim O’Reilly callback inside the factory section. Speaker notes credit Tim Bei/Ko’s mention and Edie Freedman’s 1988 cover. Fits at 720p and 1080p in every face. Move it or trim it as you like.
  >
  > (The deck-grid slide 3 is now one slide short of the deck — happy to reshoot tomorrow.)

  > **jenna** · 2026-09-23 16:35 UTC  
  > swap the order of "Now the factory fits on a laptop." and "His factory: twenty years of writing, becoming books."

  > **shelley** · 2026-09-23 16:35 UTC  
  > Swapped, live: “His factory: twenty years of writing…” (19) now leads into “Now the factory fits on a laptop.” (20) → Mise en place. Times exchanged; the laptop slide’s two forward references (“two slides on” to the printer handoff) reworded since that slide is now near the end.
...
- [ ] 4.3 `build failed` · 401 bursts · queued builds. Since Tue 22:49 UTC: nothing. Fotis unblocked (v5 proofs, books 63–66). Watch for cblass / Casey retries after 2.2 / 2.7.
  ...
  > **shelley** · 2026-09-23 15:20 UTC  
  > Picked up on a fresh conversation (cVOEKXV) at 15:20 UTC after another handoff fail; runpage re-pointed here, notes flow again. Floor: still no attendee builds since Tue 22:48 UTC, 0 converting, v 0923.261f17e live, no checkouts. Watching.
...
## 7 · Security and recovery  — Thu 24 Sep — kept private, not exported
